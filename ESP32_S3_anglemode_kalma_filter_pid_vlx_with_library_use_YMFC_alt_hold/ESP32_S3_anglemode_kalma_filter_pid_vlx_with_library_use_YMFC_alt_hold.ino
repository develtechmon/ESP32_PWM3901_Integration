...
// ===== VL53L0X Altitude Hold Variables (Reference Code Style) =====
...
bool vlxRead = false;           // State machine for distance reading
...
// ===== VL53L0X Altitude Hold Functions (Reference Code Style) =====
...
void setup() {
  ...
  // Initialize VL53L0X altitude hold
...
void loop() {
  ...
  if (ReceiverValue[2] < 1030) {
    ...
    PrevErrorAngleRoll = PrevErrorAnglePitch = 0;    
    PrevItermAngleRoll = PrevItermAnglePitch = 0;
    // Reset position and altitude hold integrators
    integralX = integralY = 0;
